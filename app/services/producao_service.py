...
def fetch_producao_data(year=None):
    """
    ...
    """
    url = f"http://vitibrasil.cnpuv.embrapa.br/index.php?ano={year if year else 2023}&opcao=opt_02"
    try:
        ...
        for table in tables:
            ...
            for row in table.find_all('tr'):
                ...
                elif len(cols) == 2 and current_category:
        ...
        csv_path = os.path.join(os.path.dirname(__file__), '../../static_data/producao.csv')
