...
def fetch_comercializacao_data():
    ...
    try:
        ...
        csv_data = load_csv_fallback(year=None, agrupado=False,csv_path=CSV_PATH_COMERCIALIZACAO)
        return {
            "dados": csv_data,
...
def fetch_comercializacao_data_por_ano(ano):
    ...
    try:
        ...
        csv_data = load_csv_fallback(year=ano, agrupado=True,csv_path=CSV_PATH_COMERCIALIZACAO)
        if csv_data:
