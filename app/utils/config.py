...
CSV_PATH_IMPORTACAO_VINHOSMESA = os.path.join(STATIC_DATA_PATH, 'importacaoVinhosMesa.csv')
CSV_PATH_IMPORTACAO_ESPUMANTES = os.path.join(STATIC_DATA_PATH, 'importacaoEspumantes.csv')
